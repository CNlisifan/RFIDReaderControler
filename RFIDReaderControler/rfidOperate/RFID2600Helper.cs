...
{
    public class RFID2600Helper : IRFIDHelper
    {
        ...
        public void registerWriteDataFunc(deleVoid_Byte_Func func)
        {
            this.evtWriteToSerialPort = func;
        }
        public void registerStateCallbackFunc(deleVoid_RFIDEventType_Object_Func func)
        {
            this.evtCardState += new deleVoid_RFIDEventType_Object_Func(func);
        }
    }
}
